...
<?php $id_treino = $aux; ?>
<td class="column100 column2" data-column="column2"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
<?php $id_treino = $aux + 6; ?>
<td class="column100 column3" data-column="column3"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
...
<td class="column100 column5" data-column="column5"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
<td class="column100 column6" data-column="column6">--</td>
<td class="column100 column7" data-column="column7">--</td>
<td class="column100 column8" data-column="column8">--</td>
</tr>
...
<td class="column100 column4" data-column="column4"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
<td class="column100 column5" data-column="column5">--</td>
<?php $id_treino = $aux + 19; ?>
<td class="column100 column6" data-column="column6"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
<td class="column100 column7" data-column="column7">--</td>
<td class="column100 column8" data-column="column8">--</td>
</tr>
<tr class="row100">
...
<td class="column100 column7" data-column="column7"><a href="descricao_pt.php?id=<?=$instalacao_info['id']?>&nif=<?=$treinador['NIF']?>&id_treino=<?=$id_treino?>&th=2">RESERVAR</td>
<td class="column100 column8" data-column="column8">--</td>
</tr>
<tr class="row100">
