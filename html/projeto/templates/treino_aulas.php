...
<h2><a href="list_instalacoes.php">Instalações</a> &gt; <a href="list_opcoes_instalacoes.php?id=<?=$instalacao_info['id']?>"><?= $instalacao_info['localizacao'] ?> &gt; <a href="tipo_de_treinos.php?id=<?=$instalacao_info['id']?>">Treinos</a></h2>
  <section class="list">
      <ul>
        <li>
